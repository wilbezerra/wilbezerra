# ==============================================================================
#  WSB FLASH CLEAN  v3.1 (SAFE PUBLIC PROTECTED)
...
#    3. Limpeza de Icones  SAFE (sem reset de layout)       -> Toast + Log
...
#  ATENCAO:
#    1) Gere o hash SHA256 final deste proprio arquivo
#    2) Substitua PLACEHOLDER_HASH pelo hash final antes da distribuicao
# ==============================================================================
...
function Executar-Limpeza-Icones {
    ...
    # MODO SAFE:
    # - Nao reinicia o Explorer
    # - Nao remove Shell Bags / BagMRU
    # - Preserva tamanho dos icones, organizacao automatica e layout do desktop
    try {
        Add-Type @"
using System;
using System.Runtime.InteropServices;
public static class WSBFlashCleanSafeShell {
    [DllImport("shell32.dll")]
    public static extern void SHChangeNotify(int wEventId, uint uFlags, IntPtr dwItem1, IntPtr dwItem2);
}
"@ -ErrorAction SilentlyContinue | Out-Null
        [WSBFlashCleanSafeShell]::SHChangeNotify(0x08000000, 0x0000, [IntPtr]::Zero, [IntPtr]::Zero)
        [WSBFlashCleanSafeShell]::SHChangeNotify(0x2000000,  0x0000, [IntPtr]::Zero, [IntPtr]::Zero)
    } catch {}

    return @{Bytes=$bytes; Itens=$n; ShellBags=$sb; Explorer="Preservado"; Modo="SAFE"}
}
