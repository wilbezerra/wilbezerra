...
<p align="center">
  <img src="Assets/wsb_auto_clean_ge_v3.3.2.ico" width="180"/>
</p>

<p align="center">
  <b style="font-size:18px;">WSB Auto Clean - Ghost Edition</b><br>
...
WSB_AutoClean_GE/
├── 📜 Core Scripts
│   ├── WSBAutoClean - GE v3.3.2.ps1
│   └── WSBAutoClean - GE v3.3.2 (SAFE).ps1
│
├── ⚙️ Executáveis
│   ├── WSBAutoCleanGE.exe
│   └── WSBAutoCleanGE (SAFE).exe
│
├── ⚙️ Build & Automação
...
│   ├── WSB Comparativo - AutoClean vs FlashClean.html
│   ├── WSBAutoCleanGE - Manual do Usuário - v3.3.2.html
│   ├── WSB_Comparativo_AutoClean_vs_FlashClean.pdf
│   └── WSBAutoCleanGE - Manual do Usuário - v3.3.2.pdf
│
├── 📘 Documentação Base
│   ├── README.md
│   ├── PRIVACY.md
...
│   ├── WSB_AutoClean_Briefing_Tecnico.pdf
│   ├── WSB_AutoClean_Relatorio_Continuacao.pdf
│   └── WSB_AutoClean_Roadmap.pdf
│
├── 🔄 Sistema de Inicialização
│   └── (LNK gerado automaticamente na pasta Startup)WSB_AutoClean_GE/
